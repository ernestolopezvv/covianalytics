...
<body>
	...
	<form action="preguntas.php" method="POST" onsubmit="return validate()"><br>
		...
		<div class="opciones">
			...
			<input type="checkbox" id="p2.1" class="opciones" name="p2[ ]" value="MercadoLibre"><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Amazon
			<input type="checkbox" id="p2.2" class="opciones" name="p2[ ]" value="Amazon" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Facebook Marketplace
			<input type="checkbox" id="p2.3" class="opciones" name="p2[ ]" value="FacebookMarketplace" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer"> Alibaba / Aliexpress
			<input type="checkbox" id="p2.4" class="opciones" name="p2[ ]" value="Alibaba" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer"> eBay
			<input type="checkbox" id="p2.5" class="opciones" name="p2[ ]" value="eBay" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">E-shop propia de cada marca (Nike, Supreme, Walmart, Liverpool, etc)
			<input type="checkbox" id="p2.6" class="opciones" name="p2[ ]" value="E-shop" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer">Otros
			<input type="checkbox" id="p2.7" class="opciones" name="p2[ ]" value="Otros" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">No realizaba compras en línea
			<input type="checkbox" id="p2.8" class="opciones" name="p2[ ]" value="No realizaba compras en línea" ><br>
			<span class="checkmark"></span>	
			</label>
		</div>
		...
		<div class="opciones">
			...
			<input type="checkbox" id="p3.1" class="opciones" name="p3[ ]" value="Tarjeta de crédito"><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Tarjeta de débito
			<input type="checkbox" id="p3.2" class="opciones" name="p3[ ]" value="Tarjeta de débito" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Paypal
			<input type="checkbox" id="p3.3" class="opciones" name="p3[ ]" value="Paypal"><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer"> Mercado Pago
			<input type="checkbox" id="p3.4" class="opciones" name="p3[ ]" value="Mercado Pago"><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer"> Efectivo
			<input type="checkbox" id="p3.5" class="opciones" name="p3[ ]" value="Efectivo"><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer"> Transferencia electrónica
			<input type="checkbox" id="p3.6" class="opciones" name="p3[ ]" value="Transferencia electrónica"><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer"> Depósito en tiendas de conveniencia (Oxxo, 7Eleven, etc.)
			<input type="checkbox" id="p3.7" class="opciones" name="p3[ ]" value="Depósito en tiendas"><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Otros
			<input type="checkbox" id="p3.8" class="opciones" name="p3[ ]" value="Otros"><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">No realizaba compras en línea
			<input type="checkbox" id="p3.9" class="opciones" name="p3[ ]" value="No realizaba compras en línea"><br>
			<span class="checkmark"></span>	
			</label>
		</div>
		...
		<div class="opciones">
			...
			<input type="checkbox" id="p4.1" class="opciones" name="p4[ ]" value="Ropa" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Comida a domicilio (Rappi, UberEats, etc)
			<input type="checkbox" id="p4.2" class="opciones" name="p4[ ]" value="Comida a domicilio" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Super a domicilio (víveres)
			<input type="checkbox" id="p4.3" class="opciones" name="p4[ ]" value="Super a domicilio" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer"> Muebles y/o electrodomésticos
			<input type="checkbox" id="p4.4" class="opciones" name="p4[ ]" value="Muebles y/o electrodomésticos" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer"> Coleccionables
			<input type="checkbox" id="p4.5" class="opciones" name="p4[ ]" value="Coleccionables" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Libros (físicos o electrónicos)
			<input type="checkbox" id="p4.6" class="opciones" name="p4[ ]" value="Libros" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer">Computadoras y/o electrónicos
			<input type="checkbox" id="p4.7" class="opciones" name="p4[ ]" value="Computadoras y/o electrónicos" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Herramientas y ferretería
			<input type="checkbox" id="p4.8" class="opciones" name="p4[ ]" value="Herramientas y ferretería" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer"> Entretenimiento (música, tv, videojuegos, juguetes, etc.)
			<input type="checkbox" id="p4.9" class="opciones" name="p4[ ]" value="Entretenimiento" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Programas o aplicaciones
			<input type="checkbox" id="p4.10" class="opciones" name="p4[ ]" value="Programas o aplicaciones" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Reservaciones y boletos
			<input type="checkbox" id="p4.11" class="opciones" name="p4[ ]" value="Reservaciones y boletos" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer"> Artículos de higiene
			<input type="checkbox" id="p4.12" class="opciones" name="p4[ ]" value="Artículos de higiene" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer"> Artículos deportivos
			<input type="checkbox" id="p4.13" class="opciones" name="p4[ ]" value="Artículos deportivos" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Otros
			<input type="checkbox" id="p4.14" class="opciones" name="p4[ ]" value="Otros" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer">No realizaba compras en línea
			<input type="checkbox" id="p4.15" class="opciones" name="p4[ ]" value="No realizaba compras en línea" ><br>
			<span class="checkmark"></span>
			</label>
		...
		<div class="opciones">
			<label class="text-answer"> Mercado Libre
			<input type="checkbox" id="p7.1" class="opciones" name="p7[ ]" value="Mercado Libre" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Amazon
			<input type="checkbox" id="p7.2" class="opciones" name="p7[ ]" value="Amazon" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Facebook Marketplace
			<input type="checkbox" id="p7.3" class="opciones" name="p7[ ]" value="Facebook Marketplace3" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer"> Alibaba / Aliexpress
			<input type="checkbox" id="p7.4" class="opciones" name="p7[ ]" value="Alibaba/Aliexpress" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer"> eBay
			<input type="checkbox" id="p7.5" class="opciones" name="p7[ ]" value="eBay"><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">E-shop propia de cada marca (Nike, Supreme, Walmart, Liverpool, etc)
			<input type="checkbox" id="p7.6" class="opciones" name="p7[ ]" value="E-shop" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer">Otros
			<input type="checkbox" id="p7.7" class="opciones" name="p7[ ]" value="Otros" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">No realizo compras en línea
			<input type="checkbox" id="p7.8" class="opciones" name="p7[ ]" value="No realizo compras en línea" ><br>
			<span class="checkmark"></span>	
			</label>
		</div>
		...
		<div class="opciones">
			<label class="text-answer"> Tarjeta de crédito
			<input type="checkbox" id="p8.1" class="opciones" name="p8[ ]" value="Tarjeta de crédito" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Tarjeta de débito
			<input type="checkbox" id="p8.2" class="opciones" name="p8[ ]" value="Tarjeta de débito" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Paypal
			<input type="checkbox" id="p8.3" class="opciones" name="p8[ ]" value="Paypal" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer"> Mercado Pago
			<input type="checkbox" id="p8.4" class="opciones" name="p8[ ]" value="Mercado Pago" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer"> Efectivo
			<input type="checkbox" id="p8.5" class="opciones" name="p8[ ]" value="Efectivo" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer"> Transferencia electrónica
			<input type="checkbox" id="p8.6" class="opciones" name="p8[ ]" value="Transferencia electrónica" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer"> Depósito en tiendas de conveniencia (Oxxo, 7Eleven, etc.)
			<input type="checkbox" id="p8.7" class="opciones" name="p8[ ]" value="Depósito en tiendas" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Otros
			<input type="checkbox" id="p8.8" class="opciones" name="p8[ ]" value="Otros" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">No realizo compras en línea
			<input type="checkbox" id="p8.9" class="opciones" name="p8[ ]" value="No realizo compras en línea" ><br>
			<span class="checkmark"></span>	
			</label>
		</div>
		...
		<div class="opciones">
			<label class="text-answer"> Ropa
			<input type="checkbox" id="p9.1" class="opciones" name="p9[ ]" value="Ropa" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Comida a domicilio (Rappi, UberEats, etc)
			<input type="checkbox" id="p9.2" class="opciones" name="p9[ ]" value="Comida a domicilio" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Super a domicilio (víveres)
			<input type="checkbox" id="p9.3" class="opciones" name="p9[ ]" value="Super a domicilio" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer"> Muebles y/o electrodomésticos
			<input type="checkbox" id="p9.4" class="opciones" name="p9[ ]" value="Muebles y/o electrodomésticos" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer"> Coleccionables
			<input type="checkbox" id="p9.5" class="opciones" name="p9[ ]" value="Coleccionables" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Libros (físicos o electrónicos)
			<input type="checkbox" id="p9.6" class="opciones" name="p9[ ]" value="Libros" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer">Computadoras y/o electrónicos
			<input type="checkbox" id="p9.7" class="opciones" name="p9[ ]" value="Computadoras y/o electrónicos" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Herramientas y ferretería
			<input type="checkbox" id="p9.8" class="opciones" name="p9[ ]" value="Herramientas y ferretería" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer"> Entretenimiento (música, tv, videojuegos, juguetes, etc.)
			<input type="checkbox" id="p9.9" class="opciones" name="p9[ ]" value="Entretenimiento" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Programas o aplicaciones
			<input type="checkbox" id="p9.10" class="opciones" name="p9[ ]" value="Programas o aplicaciones" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Reservaciones y boletos
			<input type="checkbox" id="p9.11" class="opciones" name="p9[ ]" value="Reservaciones y boletos" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer"> Artículos de higiene
			<input type="checkbox" id="p9.12" class="opciones" name="p9[ ]" value="Artículos de higiene" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer"> Artículos deportivos
			<input type="checkbox" id="p9.13" class="opciones" name="p9[ ]" value="Artículos deportivos" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Otros
			<input type="checkbox" id="p9.14" class="opciones" name="p9[ ]" value="Otros" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer">Sigo sin realizar compras en línea
			<input type="checkbox" id="p9.15" class="opciones" name="p9[ ]" value="Sigo sin realizar compras en línea" ><br>
			<span class="checkmark"></span>
			</label>
		</div>
		<div class="pregunta">
		...
		<br>
			...
			<input type="checkbox" id="p14.1" class="opciones" name="p14[ ]" value="Diabetes" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Hipertensión
			<input type="checkbox" id="p14.2" class="opciones" name="p14[ ]" value="Hipertensión" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Obesidad
			<input type="checkbox" id="p14.3" class="opciones" name="p14[ ]" value="Obesidad" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer"> Asma
			<input type="checkbox" id="p14.4" class="opciones" name="p14[ ]" value="Asma" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Condiciones cardiacas
			<input type="checkbox" id="p14.5" class="opciones" name="p14[ ]" value="Condiciones cardiacas" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer"> Inmunodeficiencia
			<input type="checkbox" id="p14.6" class="opciones" name="p14[ ]" value="Inmunodeficiencia" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer">Hepatitis
			<input type="checkbox" id="p14.7" class="opciones" name="p14[ ]" value="Hepatitis" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Otros no listados
			<input type="checkbox" id="p14.8" class="opciones" name="p14[ ]" value="Otros no listados" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer">Ninguna
			<input type="checkbox" id="p14.9" class="opciones" name="p14[ ]" value="Ninguna" ><br>
			<span class="checkmark"></span>	
			</label>
		</div>
		...
		<br>
			...
			<input type="checkbox" id="p15.1" class="opciones" name="p15[ ]" value="Ansiedad" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Estrés
			<input type="checkbox" id="p15.2" class="opciones" name="p15[ ]" value="Estrés" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Depresión
			<input type="checkbox" id="p15.3" class="opciones" name="p15[ ]" value="Depresión" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer"> Déficit de atención
			<input type="checkbox" id="p15.4" class="opciones" name="p15[ ]" value="Déficit de atención" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer"> Baja de rendimiento laboral/académico
			<input type="checkbox" id="p15.5" class="opciones" name="p15[ ]" value="Baja de rendimiento laboral/académico" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer"> Baja autoestima
			<input type="checkbox" id="p15.6" class="opciones" name="p15[ ]" value="Baja autoestima" ><br>
			<span class="checkmark"></span>	
			</label>
			<label class="text-answer">Otros no listados
			<input type="checkbox" id="p15.7" class="opciones" name="p15[ ]" value="Otros no listados" ><br>
			<span class="checkmark"></span>
			</label>
			<label class="text-answer">Ninguna
